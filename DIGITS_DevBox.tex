...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.4\textwidth]{PCI-E}
\caption{PCI-E接口}
\label{fig:pci}
\end{figure}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.3\textwidth]{SATA3}
\caption{SATA 3.0接口}
\label{fig:sata3}
\end{figure}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.3\textwidth]{SATAE}
\caption{SATA-E接口}
\label{fig:satae}
\end{figure}
...
\begin{figure}[!ht]
  \centering 
  \subfigure[]{ 
    \includegraphics[width=0.33\textwidth]{M2}} 
  \subfigure[]{ 
    \includegraphics[width=0.24\textwidth]{M2-MSATA}} 
  \caption{M.2接口}
  \label{fig:m2}
\end{figure}
...
\begin{figure}[!ht]
  \centering 
  \subfigure[]{ 
    \includegraphics[width=0.55\textwidth]{digits_terminal}} 
  \subfigure[]{ 
    \includegraphics[width=0.6\textwidth]{digits_web}} 
  \caption{登陆DIGITS}
  \label{fig:digits}
\end{figure}
